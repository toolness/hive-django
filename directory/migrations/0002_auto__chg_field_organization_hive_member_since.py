...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Organization.hive_member_since'
        db.alter_column(u'directory_organization', 'hive_member_since', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Organization.hive_member_since'
        raise RuntimeError("Cannot reverse this migration. 'Organization.hive_member_since' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Organization.hive_member_since'
        db.alter_column(u'directory_organization', 'hive_member_since', self.gf('django.db.models.fields.DateField')())
