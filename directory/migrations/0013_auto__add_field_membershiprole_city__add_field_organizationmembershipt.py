...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MembershipRole.city'
        db.add_column(u'directory_membershiprole', 'city',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['directory.City']),
                      keep_default=False)

        # Adding field 'OrganizationMembershipType.city'
        db.add_column(u'directory_organizationmembershiptype', 'city',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['directory.City']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MembershipRole.city'
        db.delete_column(u'directory_membershiprole', 'city_id')

        # Deleting field 'OrganizationMembershipType.city'
        db.delete_column(u'directory_organizationmembershiptype', 'city_id')
