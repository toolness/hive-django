...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrganizationMembershipType'
        db.create_table(u'directory_organizationmembershiptype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'directory', ['OrganizationMembershipType'])

        # Adding field 'Organization.membership_type'
        db.add_column(u'directory_organization', 'membership_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='orgs', null=True, to=orm['directory.OrganizationMembershipType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'OrganizationMembershipType'
        db.delete_table(u'directory_organizationmembershiptype')

        # Deleting field 'Organization.membership_type'
        db.delete_column(u'directory_organization', 'membership_type_id')
