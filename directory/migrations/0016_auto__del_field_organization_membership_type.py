...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'directory_organization', 'membership_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='orgs', null=True, to=orm['directory.OrganizationMembershipType'], on_delete=models.SET_NULL, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'directory.organization': {
            ...
            'membership_types': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'orgs'", 'blank': 'True', 'to': u"orm['directory.OrganizationMembershipType']"}),
